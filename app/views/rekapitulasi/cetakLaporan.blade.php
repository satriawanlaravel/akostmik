...
<div class="box box-primary">
	<div class="box-header">
		<h3 class="box-title"><b><u>Filter Laporan</u></b></h3>
	</div><!-- /.box-header -->    
	<div class="box-body"> 
		{{Form::open(['url'=>'administrator/rekapitulasi/exportExcel','class'=>'form-horizontal','rol'=>'form','method'=>'POST'])}}     
		...
		<div class="form-group">
			<div class="col-lg-10 col-lg-offset-2">				
				<a href="" class="btn btn-primary" id="cetak"><i class="fa fa-print"> Cetak Laporan</i></a>
				<a href="{{ URL::to('administrator') }}" class="btn btn-danger"><i class="fa fa-refresh"> Batal</i></a>
			</div>
		</div>
		{{Form::close()}}                 
	</div>
...
<script type="text/javascript">
	$('document').ready(function(){
		$("#cetak").click(function(event){
			...
			window.open("{{ URL::to('administrator/rekapitulasi/cetakLap?prodi=') }}"+decodeURIComponent(prodi)+"&gangep="+decodeURIComponent(gangep)+"&tahun="+decodeURIComponent(tahun));
		});
	});
</script> 
@stop