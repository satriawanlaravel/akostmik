...
<div class="box box-primary">
	<div class="box-header">
		<h3 class="box-title"><b><u>Filter Data Terevaluasi</u></b></h3>
	</div><!-- /.box-header -->    
	<div class="box-body"> 
		{{Form::open(['url'=>'administrator/rekapitulasi/filterAllterevaluasi','class'=>'form-horizontal','rol'=>'form','method'=>'POST'])}}     
