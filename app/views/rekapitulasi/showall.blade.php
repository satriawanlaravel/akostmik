...
<div class="box box-primary">
	<div class="box-header">
		<h3 class="box-title">
			<i class="fa fa-list-ol"></i> <b>Jumlah Mahasiswa / Prodi</b>
		</h3>
	</div>
	<div class="box-body">          
		<table class="table table-bordered table-responsive">                        
			<thead>
				<tr class="active bg-light-blue">                					
					...
					<th rowspan="2" class="active bg-light-blue"><div class="style1">Jumlah Mahasiswa</div></th>					
					<th colspan="2" class="active bg-light-blue"><div class="style1">Jumlah Responden</div></th>
			...
			<tbody>
				<tr>					
					...
					<td class="text-center"><div class="style3">{{ $val->Jml_Seluruh_Mhs }}</div></td>
					<td class="text-center"><div class="style3">{{ $val->JmlAll_mhs_isi_perProdi }}</div></td>
					<td class="text-center"><div class="style3">{{ $val->PersentaseMhsisi }}</div></td>
					<td class="text-center"><div class="style3">{{ $val->JmlAll_mhs_tdkisi_perProdi }}</div></td>	
					<td class="text-center"><div class="style3">{{ $val->PersentaseMhsTdkisi }}</div></td>
...
<div class="box-body">			
	...
	<script>
		...
		var barChartData = {
			labels : ["Jumlah Mahasiswa","Jumlah Responden","Jumlah Tak Terevaluasi"],
			datasets : [
			{
				...
				data : [{{ $val->Jml_Seluruh_Mhs }},{{ $val->JmlAll_mhs_isi_perProdi }},{{ $val->JmlAll_mhs_tdkisi_perProdi }}]
			},
