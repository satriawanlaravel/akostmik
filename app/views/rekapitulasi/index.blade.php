...
<div class="box box-primary">
	<div class="box-header">
		<h3 class="box-title"><b><u>Filter Data Hasil Evaluasi</u></b></h3>
	</div><!-- /.box-header -->    
	<div class="box-body"> 
		{{Form::open(['url'=>'administrator/rekapitulasi/filterShowdata','class'=>'form-horizontal','rol'=>'form','method'=>'POST'])}}     
