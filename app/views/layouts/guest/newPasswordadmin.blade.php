...
<head>
    ...
    <title>New Password Administrator</title>    
    @include('layouts.guest.css')  
</head>
@include('addons.alert')
<body class="">
    <div class="form-box" id="login-box" style="width:385px">
        <div class="header"><b>New Password Administrator</b></div>
        {{ Form::open(['route' => 'new.passwordadmin', 'class' => 'form-horizontal', 'role' => 'form']) }}
