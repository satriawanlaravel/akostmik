...
<body class="">
    <div class="form-box" id="login-box" style="width:385px">
        <div class="header">Reset Password<br/><br/><b>Administrator</b></div>
        <form action="{{ URL::to('/prosesResetadmin') }}" method="POST">
            <div class="body bg-gray">            
                ...
                Sudah punya <a href="{{ URL::to('/auth/admin/login') }}">akun?</a>
            </div>                        
        </form>
        <div class="header">        
        </div>
