...
<div class="box box-primary">
	<div class="box-header">
		<h3 class="box-title"><b><i class="glyphicon glyphicon-edit"></i> Ubah Password Mahasiswa</b></h3>
	</div><!-- /.box-header -->    
	<div class="box-body"> 
		...
		<div class="form-group">
			<div class="col-lg-10 col-lg-offset-2">
				...
				<a href="{{ URL::to('mahasiswa') }}" class="btn btn-danger" style="width : 120px">Batal</a>
			</div>
		</div>         
		{{Form::close()}}
	</div>
